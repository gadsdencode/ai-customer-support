...
export function CopilotCustomChatUI() {
  ...
  return (
    <AgentUIProvider>
      <Card
        ref={chatCardRef}
        className="w-[85vw] mx-auto h-[70vh] flex flex-col bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 shadow-2xl rounded-xl overflow-hidden border border-blue-500/30"
      >
